...
export default function Messages() {
    ...
    //max-sm:bg-[url('/images/message-bg.webp')]

    return(
        <div className="w-full h-full bg-center bg-cover">
            <div className="relative">
            <Image className='px-7 pt-32 ' src='/images/message-content.webp' width={916} height={1034} alt="寫下給其他夥伴的祝福吧！"/>
            ...
            <a className="basis-auto" href={`/result?data=${scores}`}>
                <Image className="" src='/images/skip-btn.webp' width={214/2.5} height={132/2.5} alt="略過"/> 
            </a>
            <a className="basis-auto" href={`/result?data=${scores}`} onClick={onClick}>
                <Image className="" src='/images/submit-btn.webp' width={214/2.5} height={132/2.5} alt="送出"/>
            </a>
            </div>
        </div>
    );
