...
const items = [{text: <>你獲得一張藏寶圖，跟著藏寶圖的指示，你來到一個三叉路口前，<br/>你會選擇走：</>, 
                ...
                {text: <>這時，有一隻天使角獸從箱子裡飛了出來，為了恭喜你們找到寶藏，<br/>他決定送給你一個祝福，你想要：</>, 
                    options: ["和天使請求一小時的考慮時間", "說出自己直覺想到的第一個願望", "想要聯絡家人朋友參考他們的意見"], targets: [[3, 4, 5], [1, 2], [5, 6]]}]
...
export default function Items() {
    ...
    return (
        <div className={itemNum==2? "w-full h-full bg-[#394265] transition-colors delay-700 duration-500" : 
                                    "w-full h-full bg-[#9fa2d2] bg-[url('/images/item-bg.png')] bg-cover bg-center"}>
